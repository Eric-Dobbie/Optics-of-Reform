...
\begin{abstract}
This study investigates how racial and gender diversity in policing shapes public trust, perceptions of fairness, and willingness to cooperate with law enforcement. While previous work has shown that racial and gender representation levels matter at extreme levels, I argue that changes in the levels of representation are more important to shaping public trust than absolute levels as they act as a signal of reform. Using a preregistered survey experiment, the study isolates the causal effects of representative cues on perceived legitimacy of police departments.
\end{abstract}

\newpage
\section{Introduction}

Who the police hire matters, as the descriptive background of officers helps to shape their beliefs and, as a consequence, their behavior (\cite{kennedy2017race, shoub2021female, ba2021role}). Police, in particular, are highly visible bureaucratic actors, and their behavior is a matter of public interest as police-civilian interactions are among the most common and high stakes interactions between mass publics and the government (\cite{lipsky1980street}).  Due to the frequency and salience of interacting with the police, the public is often concerned with the descriptive makeup of police departments (\cite{peyton_beliefs_2022}), as the expectations of how police will interact with civilians are partially formed around these descriptive characteristics (\cite{mansbridge1999should, meier1975representative}).

Police departments are also clearly aware of the importance of representation in policing, especially as it relates to race and gender. During a 2015 interview with BBC News, then Norfolk Police Department chief Michael Goldsmith described the importance his department needed to recruit Black police officers. ``If you don't have a diverse, inclusive workforce, you end up not making good decisions because you don't have everybody's perspective at the table.'' Norfolk PD was aiming to increase diversity in a police department with 16\% Black officers serving a population that was 43\% Black. (\cite{NorfolkPD_BBCRecruitment_2015})\footnote{Despite the announced effort to recruit more Black officers, according to the 2020 LEMAS survey, only 19\% of officers were identified as Black following Norfolk's recruiting effort  (\cite{LEMAS2020})}. Despite the evidence that representation effects outcomes, there is scarce work available on the effect of representation on trust in institutions. Existing scholarship on the effect of representation on trust in policing focuses on static levels of representations (\cite{stauffer2023police, riccucci2014representative}) or changes across departments rather than within departments.
...
I argue that institutional level trust in police increases among historically marginalized groups as descriptive representatives are added to the department because of increased expectations of procedural justice.
...
Respondents read a manipulated news article about a department’s hiring strategy, varying the focus of the recruiting drive. The treatment vignettes displayed to respondents can be found in Appendix \ref{app:vignettes}
...
\end{equation}\label{eq:h1}

Where $Black\_Respondent$ is self-reported respondent race, taking on a value of 1 if the respondent self-identifies as Black and 0 otherwise, $D$ is treatment status, $X$ are covariates, and $\epsilon$ is the error term. The constant term, $\beta_0$, gives the baseline evaluation for the control group among the excluded category for measured covariates. $\beta_1$ gives the treatment effect of observing a racial diversity focused hiring drive, and $\beta_2$ is the difference in treatment effects between Black and non-Black respondents.

To test H2, I will utilize the subsample assigned to the treatment arm that signals gender diversity focused hiring and the control group. 

\begin{equation}
    Trust = \beta_0 + \beta_1 D + \beta_2 Female\_Respondent +  \beta_3 Female\_Respondent\times D  + \gamma \mathbf{X} + \epsilon
\end{equation}\label{eq:h1}

Where $Female\_Respondent$ is self-reported respondent gender, taking on a value of 1 if the respondent self-identifies as female and 0 otherwise, $D$ is treatment status, $X$ are covariates, and $\epsilon$ is the error term. Similar to Model \ref{eq:h1}, the constant term, $\beta_0$, gives the baseline evaluation for the control group among the excluded category for measured covariates. $\beta_1$ gives the treatment effect of observing a gender diversity focused hiring drive, and $\beta_2$ is the difference in treatment effects between female and other respondents.
...
\subsection*{Vignettes}\label{app:vignette}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Experiment/control.png}
    \caption{Control Vignette}
    \label{fig:control}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Experiment/race_vignette.png}
    \caption{Race Vignette}
    \label{fig:race}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{Experiment/women_vignette.png}
    \caption{Gender Vignette}
    \label{fig:gender}
\end{figure}
